...
const boxElements = new Uint8Array([       // Indices of the vertices
    0, 1, 2,   0, 2, 3,    // front
    4, 5, 6,   4, 6, 7,    // right
    8, 9,10,   8,10,11,    // up
...
export const nElements = boxElements.length;

export const GEOMETRY_BUFFER_ID = Symbol("boxGeom");
export const COLORS_BUFFER_ID = Symbol("boxColors");
export const ELEMENTS_BUFFER_ID = Symbol("boxElements");

export const uploadData = (renderer:WebGlRenderer) => {
    ...
    renderer.buffers.assign(COLORS_BUFFER_ID) ({
        target: WebGlConstants.ARRAY_BUFFER,
        usagePattern: WebGlConstants.STATIC_DRAW,
        data: boxColors
    });
